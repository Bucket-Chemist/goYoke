// gogent-timeout-test: Test hook to determine Claude Code's timeout behavior
//
...
//
// Usage:
//   1. Build: go build -o bin/gogent-timeout-test ./cmd/gogent-timeout-test
...
const (
	...
	LOG_FILE = "/tmp/gogent-timeout-test.log"
)
