...
- [x] JSONL reader tracks file offset
- [x] Only new lines read on file change
- [x] File rotation/replacement handled
- [x] Routing decisions displayed
- [x] Cost aggregation from events
- [x] Handoff from last session displayed
- [x] Updates within 500ms of file change
- [x] **Internal debug logger available (GAP-3)**
- [x] **Debug logs written to file when DEBUG=true**
