...
2. **Report failure** with layer context: "Layer 1 failed: my_package/core/__init__.py - [error]"
3. **Rollback recommended** (partial directory structures are worse than none)

### Special Case: __init__.py Files
...
- [ ] __init__.py files precede module files in same directory (Python)
