...
3. **Spawn Independent Sources in Parallel**
   ...
   Bash({
     command: "git diff HEAD | gemini-slave architect 'Identify architectural changes'",
   ...
   Bash({
     command: "cat CLAUDE.md agents/*/*.yaml | gemini-slave architect 'Analyze system architecture'",
