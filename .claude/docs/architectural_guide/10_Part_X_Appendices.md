...
A.1 Full Architecture Overview<br>┌────────────────────────────────────────────────────────────────────<br>│                        LISAN AL-GAIB COMPLETE ARCHITECTURE<br>│<br>└────────────────────────────────────────────────────────────────────<br>                             ┌─────────────────┐<br>                             │      USER       │<br>                             │                 │<br>                             │  Terminal/IDE   │<br>                             └────────┬────────┘<br>                                      │<br>                                      ▼<br>┌────────────────────────────────────────────────────────────────────<br>│                             ORCHESTRATION LAYER<br>│<br>│<br>│<br>│<br>┌────────────────────────────────────────────────────────────────────<br>│<br>│  │                         CLAUDE CODE ORCHESTRATOR<br>│ │<br>│  │<br>│ │<br>│  │<br>┌────────────────────────────────────────────────────────────────────<br>│ │<br>│  │  │                          AGENT TIER REGISTRY<br>│ │ │<br>│  │  │<br>│ │ │<br>│  │  │   ┌─────────┐    ┌─────────┐    ┌─────────┐<br>┌─────────────────┐     │ │ │<br>│  │  │   │  HAIKU  │    │ SONNET  │    │  OPUS   │    │     GEMINI<br>│     │ │ │<br>│  │  │   │         │    │         │    │         │    │    EXTERNAL<br>│     │ │ │<br>│  │  │   │ Scout   │    │ Primary │    │ Complex │    │<br>│     │ │ │<br>│  │  │   │ Quick   │    │ Work    │    │ Tasks   │    │  1M Context<br>│     │ │ │<br>│  │  │   │         │    │         │    │         │    │  Large<br>Files    │     │ │ │<br>│  │  │   │ $0.25/M │    │ $3/M    │    │ $15/M   │    │  ~$0.075/M<br>│     │ │ │<br>│  │  │   └─────────┘    └─────────┘    └─────────┘<br>└─────────────────┘     │ │ │<br>│  │  │<br>│ │ │<br>│  │<br>└────────────────────────────────────────────────────────────────────<br>│ │<br>│  │<br>│ │<br>│  │<br>┌────────────────────────────────────────────────────────────────────<br>│ │<br>│  │  │                       SPECIALIZED SUBAGENTS<br>│ │ │<br>│  │  │<br>│ │ │<br>**----- End of picture text -----**<br>


**==> picture [268 x 533] intentionally omitted <==**

**----- Start of picture text -----**<br>
│  │  │  haiku-scout │ architect │ memory-archivist │ memory-<br>synthesis │ ...    │ │ │<br>│  │  │<br>│ │ │<br>│  │<br>└────────────────────────────────────────────────────────────────────<br>│ │<br>│  │<br>│ │<br>│<br>└────────────────────────────────────────────────────────────────────<br>│<br>│<br>│<br>└───────────────────────────────────────┬────────────────────────────<br>                                       │<br>┌───────────────────────────────┼───────────────────────────────┐<br>       │                               │<br>│<br>       ▼                               ▼<br>▼<br>┌───────────────────┐         ┌───────────────────┐<br>┌───────────────────┐<br>│   ENFORCEMENT     │         │      STATE        │         │<br>MEMORY        │<br>│      LAYER        │         │      LAYER        │         │<br>LAYER        │<br>│                   │         │                   │         │<br>│<br>│  .claude/hooks/   │         │  .claude/tmp/     │         │<br>.claude/memory/  │<br>│                   │         │                   │         │<br>│<br>│  ┌─────────────┐  │         │  ┌─────────────┐  │         │<br>┌─────────────┐  │<br>│  │ PreToolUse  │  │         │  │scout_metrics│  │         │  │<br>decisions/  │  │<br>│  │ PostToolUse │  │         │  │complexity   │  │         │  │<br>sharp-edges/│  │<br>│  │ SubagentStop│  │         │  │handoff.json │  │         │  │<br>facts/      │  │<br>│  │ SessionEnd  │  │         │  │routing_log  │  │         │  │<br>preferences/│  │<br>│  └─────────────┘  │         │  └─────────────┘  │         │<br>│observations/│  │<br>│                   │         │                   │         │<br>└─────────────┘  │<br>│  Routing          │         │  Inter-agent      │         │<br>│<br>│  Enforcement      │         │  Communication    │         │<br>Persistent       │<br>│  Validation       │         │  Checkpoints      │         │<br>Learning         │<br>│  Logging          │         │  Ephemeral        │         │  Git<br>Versioned    │<br>│                   │         │                   │         │<br>│<br>└───────────────────┘         └───────────────────┘<br>└───────────────────┘<br>       │                               │<br>│<br>└───────────────────────────────┴───────────────────────────────┘<br>                                       │<br>                                       ▼<br>                             ┌───────────────────┐<br>                             │   EXTERNAL LAYER  │<br>                             │                   │<br>                             │  .gemini-slave/   │<br>                             │                   │<br>                             │  CLI Integration  │<br>                             │  Large Context    │<br>                             │  Parallel Workers │<br>                             │                   │<br>                             └───────────────────┘<br>**----- End of picture text -----**<br>
...
_End of Lisan al-Gaib Architecture & Implementation Guide_ 
