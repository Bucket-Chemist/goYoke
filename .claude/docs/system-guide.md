# GoGent: Technical Manual & System Guide
...
GoGent is a **Tiered Multi-Agent System** that orchestrates two distinct intelligence classes into a cohesive unit. It solves the "Reasoning vs. Context" trade-off by enforcing a strict division of labor.
...
- **`hooks/`**: Bash scripts that enforce rules _before_ the LLM can act.
...
GoGent enforces cost discipline via **Code-Enforced Routing**.
...
**GoGent** is an operational doctrine that:
