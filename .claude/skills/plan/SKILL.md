...
```
[plan] GAP document ready: SESSION_DIR/einstein-gap-<timestamp>.md
...
_Generated by /plan skill. Review critique: SESSION_DIR/review-critique.md_
```
...
| `SESSION_DIR/review-metadata.json` | staff-architect   | /plan workflow             | Review verdict and counts    |
| `SESSION_DIR/einstein-gap-*.md`    | /plan (if needed) | /einstein                  | Escalation context           |
