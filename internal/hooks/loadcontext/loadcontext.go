...
func Main() {
	...
	// CLAUDE.md is injected by the TUI via --append-system-prompt-file (from embedded FS).
	// The hook only provides dynamic context (session dir, git state, routing tiers).
