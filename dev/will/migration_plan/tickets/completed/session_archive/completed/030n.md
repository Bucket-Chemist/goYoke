...
## Description
Implement Generator interface for deterministic and randomized test inputs.

## Implementation Intention
Provide both fixture-based deterministic generation for regression testing and seeded random generation for fuzz testing. Seed control ensures reproducibility.

## Intended End State
- Generator loads deterministic fixtures from JSON files
- Random generation uses seeded RNG for reproducibility
- FuzzParams allows distribution tuning
- Same seed always produces same sequence

## Dependencies
- GOgent-030m: Core types defined
...
## Acceptance Criteria
- [x] Deterministic generation loads from fixtures
- [x] Random generation uses seeded RNG
- [x] FuzzParams allows distribution overrides
- [x] Tests verify reproducibility
...
## Why This Matters
The generator is the source of all test inputs. Reproducibility via seeding is essential for debugging failures - you can replay exact conditions that caused a crash.
