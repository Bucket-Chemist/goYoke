...
## Acceptance Criteria
- [ ] All flags parsed and validated
- [ ] `-mode=deterministic` runs fixture-based tests
- [ ] `-mode=fuzz` runs randomized tests
- [ ] `-mode=mixed` runs both
- [ ] `-replay` re-executes a crash file
- [ ] Reports generated to specified output directory
