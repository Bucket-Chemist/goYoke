...
## Acceptance Criteria
- [ ] Invariant struct type defined
- [ ] PreToolUseInvariants slice with 5 invariants
- [ ] SessionEndInvariants slice with 4 invariants
- [ ] CheckInvariants() function for batch checking
- [ ] Tests verify invariant logic
- [ ] Invariants integrate with FuzzRunner
